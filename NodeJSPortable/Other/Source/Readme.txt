...
user in an INI file next to PHPPortable.exe called PHPPortable.ini.
...
copy AppNamePortable.ini from this directory to PHPPortable.ini next to
PHPPortable.exe. The options in the INI file are as follows:
